          ...
          <div class="container"><br>
            ...
            <form class="needs-validation shadow-lg p-3 mb-5 bg-body rounded mt-4" action="${pageContext.request.contextPath}/GerenteServlet?action=${empty cadastrado ? "novoCadastro" : stringAlterar}" method="post">
                ...
                <div class="form-group">
                    ...
                    <c:if test="${empty cadastrado}">
                        <input type="text" class="form-control" name="cpf" data-mask="000.000.000-00" placeholder="${cadastrado.cpf}" value="${cadastrado.cpf}" required>
                    </c:if>
                    <c:if test="${!empty cadastrado}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="telefone"  data-mask="(00) 00000-0009" placeholder="${cadastrado.telefone}" value="${cadastrado.telefone}" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="cep" data-mask="00.000-000" laceholder="${cadastrado.endereco.cep}" value="${cadastrado.endereco.cep}" required>
                </div>
                <div class="form-group">
